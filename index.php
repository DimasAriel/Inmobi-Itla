...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="/inc/Functions/Login.php" method="post">
  ...
  <!-- /.login-box-body -->
      ...
      <div class="col-xs-12 clearfix">
                ...
                <p>Usuario u contraseña incorrectos.</p>
              </div>
              </div>
        </div>
</div>
...
<!-- jQuery 2.2.0 -->
<? include $_SERVER['DOCUMENT_ROOT'] . "/inc/Bundles/Scripts.php" ?>
		  ...
		  $.ajax({
				...
				response = JSON.parse(response);
					if (response.Status == 0) {
					  $("#LoginError").show();
					  $("#LoginError p").html(response.Msj);
